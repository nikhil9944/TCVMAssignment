...
import com.tcvm.controller.TCVMController;
...
public class TCVMMenuTest {
	...
	@Test
	public void shouldCallTCVMController() {
		//TCVMController tcvmController = new TCVMController();
	}
	
	@Test
	public void shouldCallTestSuiteClass() {
		//SuiteClasses suiteClasses = new SuiteClasses();
	}
}
