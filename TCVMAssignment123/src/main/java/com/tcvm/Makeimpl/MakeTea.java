...
import com.tcvm.services.AllDrinkAvailability;
...
public class MakeTea implements TCVMMakingDrink {
	...
	//private AllDrinkAvailability drinkAvailability;
	...
	public void makeProcess(int productQuantity) throws IOException {
			...
			productRecord.addProductInList(
					new Product("Tea", productQuantity, productQuantity * TEA_PRICE));
			System.out.println("Your Tea Is Ready!");
			System.out.println(productQuantity + " cup tea " + productQuantity + "*" + TEA_PRICE + " = Rs."
